...
MulArray3(float factor, float array0[3])
{
	...
	array[0] = factor*array[0];
	array[1] = factor*array[1];
	array[2] = factor*array[2];
	array[3] = 1;
	return array;
}
...
//-----------------------------------------------------------------------------------------------//
	...
	SetPointLight(GL_LIGHT0,0.,0.,0.,.8,.8,.8);
	...
	glTranslatef(0., 0., 0.+3*sin(Time*M_PI));
	glutSolidCube(.5);
